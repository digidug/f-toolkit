<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../upimg/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../upimg/'; // absolute or relative from this script path, required.
